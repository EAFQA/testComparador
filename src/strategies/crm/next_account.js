...
var constructor =  {
	...
	"loadTable" : function( resquest, issort ){
		...
		var table = {
			...
			"path" : path,
			"showbutton" : true,
			"formedit" : "/pages/crm/edit?entity=next_account",
			"type" : "list",
			"scriptList" : [
	...
	"loadFormData" : function( request ){
		...
		var defaultFormData = {
			"entityname" : "next_account",
			"title" : "Cliente",
			"path" : "Atendimento > Clientes > ",
			"formback" : "/pages/crm/list?entity=next_account",
			"primary" : {
				"background": "../../img/crm/background/profile-bg.jpg",
