...
var constructor =  {
	...
	"loadTable" : function( resquest, issort ){
		...
		var title = "Prioridades";
		var path = "Atendimento > Prioridades > ";
		...
		var table = {
			"entityname" : "next_priority",
			"title" : title,
			"path" : path,
			"showbutton" : true,
			"formedit" : "/pages/crm/edit?entity=next_priority",
			"type" : "list",
			"scriptList" : [
		...
		var promise = new Promise( function( resolve, reject){
				require("../../../src/dao/daoFactory")().then(function(db){
                    ...
                    db.collection("next_priority").find( {} ).toArray( ( error, results ) => {
	...
	"loadFormData" : function( request ){
		...
		var defaultFormData = {
			"entityname" : "next_priority",
			"title" : "Prioridade",
			"path" : "Atendimento > Prioridades > ",
			"formback" : "/pages/crm/list?entity=next_priority",
			"primary" : {
        ...
        if( request.query.id ){
            ...
            promise = new Promise( function(resolve){
                require("../../../src/dao/daoFactory")().then(function(db){
                    db.collection("next_priority").findOne({ "_id" : ObjectId(entityid) }, ( error, to ) => {
