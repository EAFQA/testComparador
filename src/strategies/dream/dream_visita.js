...
var constructor =  {
	...
	"loadTable" : function( resquest, issort ){
		...
		var table = {
			"entityname" : "dream_visita",
			"title" : title,
			"path" : path,
			"showbutton" : true,
			"formedit" : "/pages/dream/edit?entity=dream_visita&modulename=crm",
			"type" : "list",
			"scriptList" : [
		...
		var promise = new Promise( function( resolve, reject){
				require("../../../src/dao/daoFactory")().then(function(db){
                    ...
                    db.collection("dream_visita").find( criteria ).sort( { "created" : -1 } ).toArray( ( error, results ) => {
	...
	"loadFormData" : function( request ){
		...
		var defaultFormData = {
			"entityname" : "dream_visita",
			"title" : "Visita",
			"path" : "Formulários > Visitas > ",
			"modulename" : "crm",
			"formback" : "/pages/dream/list?entity=dream_visita&modulename=crm",
			"primary" : {
        ...
        if( request.query.id ){
            ...
            promise = new Promise( function(resolve){
                require("../../../src/dao/daoFactory")().then(function(db){
                    db.collection("dream_visita").findOne({ "_id" : ObjectId(entityid) }, ( error, to ) => {
